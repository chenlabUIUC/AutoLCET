...
class ScrollableFrame(ttk.Frame):
    def __init__(self, parent):
        ...
        # Mousewheel scrolling (Windows/macOS; Linux handled separately)
...
class ScreenGrabberApp:
    def __init__(self, root):
        ...
        self.root.geometry("1000x1000")  # Width x Height in pixels
        ...
        self.obj_pos_label = tk.Label(self.ui, text="Object @ (x, y): (—, —)")
        ...
        ## Text box
        self.text_inputs_frame = tk.Frame(self.ui)
        ...
        self.checkbox = tk.Checkbutton(self.ui, text="W == H?", variable=self.square_var,
                                       command=self.toggle_height_slider)
        self.checkbox.pack()

        self.fps_label = tk.Label(self.ui, text="FPS: 0")
        self.fps_label.pack()
        ...
        self.canvas = FigureCanvasTkAgg(self.fig, master=self.ui)
        self.canvas.get_tk_widget().pack(fill=tk.BOTH, expand=True)

        # This is the circle at botton
        self.log_box = tk.Text(self.ui, height=10, width=80, state='disabled')
        self.log_box.pack(pady=5)
        
        # This is the circle at botton
        self.status_canvas = tk.Canvas(self.ui, width=20, height=20, highlightthickness=0)
